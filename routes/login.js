...
router.route('/')
    ...
    .post(function(req, res) {
        ...
        Parse.User.logIn(req.body.username.toLowerCase(), req.body.password).then(function(object) {
            if (object && object.get("type") === "admin" && (object.get("adminAccess") === true || object.get("superAdminAccess") === true ||object.get("creatorAccess") === true || object.get("editorAccess") === true)) {
