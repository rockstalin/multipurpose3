...
exports.SUPER_ADMIN_FULL_NAME = "Server Name"
...
/*
 ...
 curl -X GET \
 -H "X-Parse-Application-Id: nKGMODkppJvk5RtYC5Fu" \
 -H "X-Parse-Master-Key: 7NVq2LDGnYaIttTEEw3L" \
 http://localhost:8080/parse/installations
 
 
  curl -X POST -H "X-Parse-Application-Id: nKGMODkppJvk5RtYC5Fu" -H "Content-Type: application/json" -d '{"data": {"alert": "My message"}}' http://174.138.68.69:8080/parse/functions/sendPushToUser
...
"where": {
    "deviceType": "ios",
 "deviceToken": "647c95382d9cdf08c84bf928a68a22cea62f30ea1ecc96bb73d620b1769de22e"

 },
"data": {
    "alert": "Hello, Parse!"
}
}' http://localhost:8080/parse/push
*/
...
exports.APP_NAME = 'Church Name'; // This Name will be shown in Parse Dashboard
exports.DATABASE_NAME = 'multipurpose1'; // Database will be created/used in MongoDB with this name
...
exports.FAKE_MINIMUM = 0
exports.FAKE_MAXIMUM = 0
