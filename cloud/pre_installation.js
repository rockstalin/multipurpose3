...
Parse.Cloud.define("installation", function(request, response) {
                   ...
                   console.log('*** Cloud function installation = ', objectId , request.params );
...
Parse.Cloud.define("addInstallation", function(request, response) {
    ...
    var appIdentifier = request.params.appIdentifier;//newly added
    var localeIdentifier = request.params.localeIdentifier;
    var appName = request.params.appName;

                   console.log('*** Cloud function addInstallation = ', appName, objectId , request.params );
    ...
    if (!appId) {
        ...
        query.find().then(function(results) {
            ...
            if (object) {
                ...
                if (!(object.get("appName") === appName)) {
                object.set("appName", appName)
                }
                if (!(object.get("appIdentifier") === appIdentifier)) {
                object.set("appIdentifier", appIdentifier)
                }
                if (!(object.get("localeIdentifier") === localeIdentifier)) {
                object.set("localeIdentifier", localeIdentifier)
                }
...
Parse.Cloud.define("updateInstallation", function(request, response) {
                   ...
                   var objectId = request.params.adminId;
                   console.log('*** Cloud function updateInstallation = ', objectId , request.params );
