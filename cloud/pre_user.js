       ...
       var pushQuery = new Parse.Query("_Installation");
        ...
        var data = {
            ...
            id: userId
                   ...
                   console.log("sendPushToUser 1 ", data,pushQuery);
        ...
        .then(function() {
              ...
              console.log("sendPushToUser 2", request.params);
            ...
            response.error(error)
                   ...
                   console.log("before Parse.Query", pushQuery);

                   pushQuery.equalTo("deviceType", "ios");
                   
                   console.log("after Parse.Query", pushQuery);
